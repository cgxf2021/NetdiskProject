/****************************************************************************
** Meta object code from reading C++ file 'online.hpp'
**
...
#error "The header file 'online.hpp' doesn't include <QObject>."
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSOnlineENDCLASS_t qt_meta_stringdata_CLASSOnlineENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 19),  // "addFriendBtnClicked"
        QT_MOC_LITERAL(27, 0)   // ""
    },
    "Online",
    "addFriendBtnClicked",
...
void Online::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->addFriendBtnClicked(); break;
        default: ;
        }
    }
    (void)_a;
